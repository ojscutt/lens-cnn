...
# ======================================================================================
# USER INPUTS
set_size = 5 #set desired number of images in dataset
res_scale = 1 #set desired resolution scaling factor (60x60=1, 30x30=0.5 etc.)
im_set = 1 #define image set to create, 1 = train, 2 = test
...
for k in range(set_size):
    ...
    ## define complex ellipticity components e1 and e2
    q = 1.3
    phi = 0
